...
#else
int Microseconds, Dhrystones_Per_Second;
#endif
#else
float           Microseconds,
                Dhrystones_Per_Second;
...
printf("User_Time = %d - %d = %d\n", End_Time,  Begin_Time, User_Time);
printf("Too_Small_Time = %d\n", Too_Small_Time);
  ...
  printf ("\n");
    ...
    Dhrystones_Per_Second = ((long long) HZ * (long long) Number_Of_Runs)
                        / (long long) User_Time;
#else
    Microseconds = User_Time / ((HZ/1000000) * Number_Of_Runs);
